...
void day1::day1p2() { day1logic(true); }

void day1::day1p1() { day1logic(true); }
  ...
  for (value1 = 0; value1 < numbers.size(); ++value1) {
    for (value2 = value1; value2 < numbers.size(); ++value2)
      if ((numbers[value1] + numbers[value2]) == 2020) {
        std::cout << "numbers[value1]: " << numbers[value1]
                  << " ; numbers[value2]: " << numbers[value2]
                  << "; resultado: " << numbers[value1] + numbers[value2]
                  << std::endl;
...
void day1::day1logic(bool isPart1) {
   ...
   *  1456
   *
   *  the 2 numbers are 1721 and 299 both mutplied give 513579 so thats the
   * answer
   */
  ...
  if (numbers.empty()) {
    throw std::runtime_error("No numbers in the file.");
  }
  // print file
  // for (auto i : numbers)
  //     std::cout << i << std::endl;
